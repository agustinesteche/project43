...
const {presets} = require(`${webDirectory}/babel.config.js`);
...
const babelLoaderConfiguration = {
  ...
  include: [
    path.resolve(webDirectory, 'index.web.js'), // Entry to your application
...
module.exports = {
  entry: {
    app: path.join(webDirectory, 'index.web.js'),
  },
  output: {
